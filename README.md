...
‼️می‌توانید از هرکدام از فایل‌های نسخه‌های BETA هم استفاده نمایید، (مثل C (Cython) و JavaScript و Ruby) ولی هیچ مسئولیتی از جمله کار نکردن نسخه‌های BETA و... برای توسعه‌دهنده نیست و لطفا در صورت وجود مشکل آن را به ما بگویید... (از طریق SUPPORT.md یا Issues یا...)
